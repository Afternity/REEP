...
using REEP.WebApi.Controllers.ContractControllers.ContractTypeControllers;

namespace REEP.WebApi.Controllers.WarrantyControllers.WarrantyTypeControllers
{
    public class WarrantyTypeController
    {
        private readonly IMapper _mapper;
        private readonly ILogger<WarrantyTypeController> _logger;

        public WarrantyTypeController(
            IMapper mapper,
            ILogger<WarrantyTypeController> logger) =>
