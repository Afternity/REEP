...
{
    public class HardDeleteContractTypeCommandHandler : IRequestHandler<HardDeleteContractTypeCommand, Unit>
    {
        private readonly IReepDbContext _context;

        public HardDeleteContractTypeCommandHandler(IReepDbContext context) =>
            _context = context;
